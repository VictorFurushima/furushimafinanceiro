  ...
  return (
    <div className="p-4 sm:p-6 lg:p-10 space-y-6 max-w-7xl mx-auto">
      <header className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <p className="text-sm text-muted-foreground">
            Previsão de entradas e liberação de limite
          </p>
      ...
      <Card className="bg-gradient-card border-border/50 shadow-card">
        <CardHeader>
          <CardTitle className="font-display">Todas as recargas</CardTitle>
        </CardHeader>
        <CardContent>
          {filtered.length === 0 ? (
              ...
              {filtered.map((r) => (
                <li key={r.id} className="py-3 flex items-center gap-4 flex-wrap">
                  <div
                    ...
                    style={{
                      background: `${rechargeTypeColor(r.recharge_type)}25`,
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <Badge
                        ...
                        className="text-[10px]"
                        style={{
                          borderColor: rechargeStatusColor(r.status),
                          color: rechargeStatusColor(r.status),
                        }}
                      >
